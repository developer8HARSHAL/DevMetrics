...
class ApiKey {
  ...
  static async create({ key, owner, description = '', status = 'active', requestsPerHour = 10000, requestsPerDay = 100000, expiresAt = null }) {
    const sql = `
      INSERT INTO api_keys (key, owner, description, status, requests_per_hour, requests_per_day, expires_at)
      VALUES ($1, $2, $3, $4, $5, $6, $7)
      RETURNING *
    `;
    const values = [key, owner, description, status, requestsPerHour, requestsPerDay, expiresAt];
